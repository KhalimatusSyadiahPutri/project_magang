...
use App\Export\AnggotaExport;
use App\Models\user;
use Barryvdh\DomPDF\Facede\Pdf;
use Carbon\Carbon;
use Iluminate\Support\Facedes\Hash;
...
class UserController extends Controller
{
   public function index(Request $request)
   {
    ...
    $data = User::with(['pangkat', 'jabatan'])->select();
   ...
   public function store(Request $request)
   {
    ...
    if($user){
        return redirect('danramil/anggota')->with('berhasil','Anggota Berhasil Ditambahkan');
    } else {
        return redirect('danramil/anggota/create');
    }
 }
 ...
 // fungsi untuk update data
  public function update(Request $request, $id)
  {
    $request->validate([
     ...
     return redirect('danramil/anggota')->with('berhasil', 'Anggota Berhasil Diperbarui');
 }

 public function delete($id)
 {
     User::findOrFail($id)->delete($id);
     return redirect('danramil/anggota')->with('berhasil', 'Anggota Berhasil Dihapus');
 }

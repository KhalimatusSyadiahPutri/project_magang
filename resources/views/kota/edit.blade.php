            ...
            <div class="section-body">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ url('danramil/kota/' . $data->id . '/update') }}">
                            @method('PUT')
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="kode_kota" id="kode_kota" class="form-control"
                                    placeholder="Masukan Nama Kota" value="{{ $data->kode_kota }}">
                            </div>

                            <div class="form-group">
                                <label for="nama_kota">Nama Kota</label>
                                <input type="text" name="nama_kota" id="nama_kota" class="form-control"
                                    placeholder="Masukan Nama Kota" value="{{ $data->nama_kota }}">
                            </div>
